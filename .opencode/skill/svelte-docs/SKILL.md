---
name: svelte-docs
description: Complete reference of available Svelte 5 and SvelteKit 2 documentation sections with use cases and paths
license: MIT
...
This index serves as a replacement for the `list-sections` MCP tool. Instead of calling `list-sections` every time, you can reference this skill to quickly identify which documentation sections are relevant for a given task.

## When to Use This Skill

Use this skill in OpenCode environments when you need to:

- Find relevant Svelte or SvelteKit documentation for a specific task
- Understand which documentation sections cover particular features
- Identify all documentation needed for a complex feature implementation
- Replace calls to the `list-sections` MCP tool
